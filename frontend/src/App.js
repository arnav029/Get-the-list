...
function App() {
  ...
  return (
    <div className="App list-group-item  justify-content-center align-items-center mx-auto" style={{"width":"400px", "backgroundColor":"white", "marginTop":"15px"}} >
      <h1 className="card text-white bg-primary mb-1" styleName="max-width: 20rem;">Get-the-list</h1>
      <h6 className="card text-white bg-primary mb-3">Enter your tasks along with their description</h6>
